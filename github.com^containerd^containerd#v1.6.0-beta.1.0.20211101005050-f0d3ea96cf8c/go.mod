module github.com/containerd/containerd-v1.6.0-beta.1.0.20211101005050-f0d3ea96cf8c

go 1.17

require github.com/containerd/containerd v1.6.0-beta.1.0.20211101005050-f0d3ea96cf8c
